...
def normalize_quiz_html(html: str) -> str:
    ...
    retry_html = "<p><img src='/shared/ContentTemplates/msu-brand/4b7080-colorbar.png' alt='' title='' data-d2l-editor-default-img-style='true' style='max-width: 100%;margin-top: 50px'></p><p><button type='button' class='btn btn-primary' onclick='location.reload()'><strong>Refresh</strong></button> the page if you would like to try again.</p>"
